...
import Map from './Map'
export default function AllDestinationDetailsClient({destinationInfo}) {
    
      const [selectedDate, setSelectedDate] = useState(destinationInfo.destination?.availability?.[0] || null);
  return (
    <div className="max-w-6xl mx-auto p-4 lg:p-8  mt-12">
      {/* Image Section */}
      <div className="relative w-full h-72 md:h-[420px] rounded-2xl overflow-hidden shadow-xl">
        <img
      ...
      <div className="mt-8 grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <div className="p-4 bg-neutral rounded-xl shadow-sm">
          ...
          <div>
            ...
            <div className="bg-neutral rounded-xl shadow-sm p-4">
        ...
        <aside className="space-y-6">
          <div className="sticky top-20 p-6 bg-neutral rounded-xl shadow-lg">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {destinationInfo.availability.map((date) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-sm badge transition ${selectedDate === date
            ...
            {/* <Link src="/booking"> */}
            <button className="btn border-0 bg-gradient-to-r from-orange-400 to-red-400 w-full mt-6 rounded-4xl text-white">Proceed to Checkout</button>
            {/* </Link> */}
