...
export default function DestCard({ tour }) {
  ...
  return (
    <Link href={`/destinations-details/${tour._id}`}>
      <div className="rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition relative bg-white h-fit cursor-pointer">
        ...
        <div className="p-4 space-y-2">
          ...
          <p className="text-sm text-gray-600">
            from <span className="font-bold text-lg text-orange-500">${tour.price || "0"}</span> /person
          </p>
        </div>
